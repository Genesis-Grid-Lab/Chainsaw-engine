...
// starts input field
CSE_INLINE void BeginInput(const char* label)
{
    ImGui::PushID(label);
...
CSE_INLINE bool InputBool(const char* label, bool* value)
{
    BeginInput(label);
...
CSE_INLINE bool InputFloat(const char* label, float* value)
{
    BeginInput(label);
...
// shows button
CSE_INLINE bool InputButton(const char* label,const ImVec2& size = ImVec2(0,0))
{
...
CSE_INLINE bool InputCombo(const char* label, const std::vector<const char*>& combos)
{
    BeginInput(label);
...
CSE_INLINE bool InputText(const char* label, char* value, const char* hint = nullptr, size_t size = 32)
{
    BeginInput(label);

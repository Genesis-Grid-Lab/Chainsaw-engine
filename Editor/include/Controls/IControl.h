...
{
    CSE_INLINE virtual ~IControl() = default;

    CSE_INLINE IControl(GuiContext* context):
    IWidget(context)
    {}
    ...
    CSE_INLINE void SetTitle(const char* title) override
    {
        m_Title = title;
    }
...
// activate small font
    ...
    protected:
    CSE_INLINE void virtual OnMenu(GuiContext*, Entity&) {}
    CSE_INLINE void virtual OnBody(GuiContext*, Entity&) {}
